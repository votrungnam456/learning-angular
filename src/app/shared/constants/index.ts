...
export const LIST_FORM_DATA = [
  {
    ...
    data: [
      ...
      { label: 'Name', type: 'string', data: '', placeholder: 'Enter name' },
      { label: 'City', type: 'string', data: '', placeholder: 'Enter city' },
      { label: 'State', type: 'string', data: '', placeholder: 'Enter state' },
      ...
      { label: 'wifi', type: 'checkbox', data: true, placeholder: '' },
      { label: 'laundry', type: 'checkbox', data: true, placeholder: '' },
    ],
  },
  {
    type: 'shopping',
    data: [
      ...
      { label: 'Price', type: 'number', data: 0, placeholder: 'Enter price' },
      {
